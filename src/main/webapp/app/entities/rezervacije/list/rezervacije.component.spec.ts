...
describe('Rezervacije Management Component', () => {
  let comp: RezervacijeComponent;
  let fixture: ComponentFixture<RezervacijeComponent>;
  let service: RezervacijeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'rezervacije', component: RezervacijeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(RezervacijeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rezervacijes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
