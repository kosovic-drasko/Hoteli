...
describe('Sobe Management Component', () => {
  let comp: SobeComponent;
  let fixture: ComponentFixture<SobeComponent>;
  let service: SobeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'sobe', component: SobeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SobeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sobes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
