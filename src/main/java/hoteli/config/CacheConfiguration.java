...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hoteli.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hoteli.repository.UserRepository.USERS_BY_EMAIL_CACHE);
